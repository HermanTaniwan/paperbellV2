...
try {
    ...
    if ($action === 'orders') {
        ...
        if($paperFilter==='all'){
            ...
            $pageOrderBy=$filter==='printed'?"COALESCE((SELECT MAX(sort_lines.printed_at) FROM order_process sort_lines WHERE sort_lines.order_sn=o.order_sn AND sort_lines.printed=1),0) DESC,o.create_time DESC":"o.create_time DESC";
