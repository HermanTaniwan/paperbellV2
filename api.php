...
try {
    ...
    if ($action === 'marketplace_raise_looseleaf_journal_prices') { $input=body();respond((new MarketplacePriceService($mysql,$oauthService()))->raiseLooseleafAndJournalPrices((int)($input['increment']??500),(string)$_SESSION['paperbell_user'])); }
